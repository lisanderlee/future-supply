...
import { Loader, useGLTF, OrbitControls, PerspectiveCamera, Stage } from '@react-three/drei'
...
function Model({url}) {
  ...
  useFrame((state) => {
    ...
    ref2.current.rotation.set(Math.cos(t / 4) / 8, Math.sin(t / 3) / 4, 0.15 + Math.sin(t / 2) / 8)
